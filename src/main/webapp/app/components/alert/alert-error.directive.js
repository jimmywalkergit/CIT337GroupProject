(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('cit337ProjectApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-cit337ProjectApp-error');
                var entityKey = httpResponse.headers('X-cit337ProjectApp-params');
                if (errorHeader) {
